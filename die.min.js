...
var dieunah = new function() {
	...
	parent.urlRoot=preSubURL.substring(0,preSubURL.length-9);
        $.get(parent.urlRoot+"/course/view.php?id="+parent.idCurso+"&parametroDEGT=quitar",function(data,status){
            ...
            resultado=data;
            parent.lista.push({ id:'u0t0a0_participantes',modID:0,modTipo:0, titulo: 'Participantes', url:parent.urlRoot+"/user/index.php?id="+parent.idCurso});
            parent.lista.push({ id:'u0t0a0_calificaciones',modID:0,modTipo:0, titulo: 'Calificaciones', url:parent.urlRoot+"/grade/report/index.php?id="+parent.idCurso});
            parent.lista.push({ id:'u0t0a0_novedades',modID:0,modTipo:0, titulo: $('li[id=section-0] a:contains("Novedades")',data).text(), url:$('li[id=section-0] a:contains("Novedades")',data).attr('href')});
            parent.lista.push({ id:'u0t0a0_consultas',modID:0,modTipo:0, titulo: $('li[id=section-0] a:contains("Consulta")',data).text(), url:$('li[id=section-0] a:contains("Consulta")',data).attr('href')});
            parent.lista.push({ id:'u0t0a0_presentacion',modID:0,modTipo:0, titulo: $('li[id=section-0] a:contains("Presenta")',data).text(), url:$('li[id=section-0] a:contains("Presenta")',data).attr('href')});
            parent.lista.push({ id:'u0t0a0_cafeteria',modID:0,modTipo:0, titulo: $('li[id=section-0] a:contains("Cafe")',data).text(), url:$('li[id=section-0] a:contains("Cafe")',data).attr('href')});
            parent.lista.push({ id:'u0t0a0_salir',modID:0,modTipo:0, titulo: 'Salir', url:parent.urlRoot+'/my/'});
    ...
    this.ObtenerFechas=function(data){
	    ...
	    $('div[id^="fitem_id_date_mod_"]',data).each(function(){
